...
[L_pArc, R_pArc] = AFQ_Segment_PostArcuate(dt, wholebrainfgPath, baseDir);
...
if ~isempty(L_fg_vert.fibers)
    ...
    L_VOF=AFQ_removeFiberOutliers(L_VOF,3,100,25);
    L_pArc=AFQ_removeFiberOutliers(L_pArc,3,100,25);
else
    L_VOF = [];
    L_pArc_vot = [];
end
